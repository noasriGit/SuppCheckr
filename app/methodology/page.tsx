...
const CRITERIA_DESCRIPTIONS: Record<keyof typeof CRITERIA_LABELS, string> = {
  ingredientTransparency:
    "How clearly the label identifies active ingredients and forms (for example, creatine monohydrate or magnesium glycinate).",
  doseTransparency:
    "How clearly the label states the active dose per serving — grams of creatine, milligrams of elemental magnesium, or equivalent.",
  evidenceAlignment:
  ...
  priceValue:
    "Dated manual price checks compared on a category-normalized basis (for example, price per 5 g creatine or per 100 mg elemental magnesium).",
  additives:
    ...
    <PageContainer>
      ...
      <section className="mt-10">
        ...
        <ul className="mt-3 max-w-3xl list-disc space-y-2 pl-5 text-sm text-foreground">
          <li>
            Category-specific scoring profiles exist. Creatine and Magnesium can use
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 max-w-3xl text-sm text-foreground">
          ...
          profiles currently include Creatine and Magnesium:
        </p>
