...
export const metadata = buildPageMetadata({
  ...
  description:
    "Ingredient reference pages for Creatine monohydrate, Magnesium, Vitamin C, Electrolytes, and CoQ10 — forms, label reading, dosage context, and safety notes.",
  path: "/ingredients",
  noindex: true,
});
  ...
  return (
    <PageContainer>
      ...
      <p className="mt-3 max-w-2xl text-foreground">
        ...
        cover Creatine monohydrate, Magnesium, Vitamin C, Electrolytes, and CoQ10.
      </p>
